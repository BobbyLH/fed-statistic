...
sql_create_table_log = 'CREATE TABLE log (id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, project_id INT(11) NOT NULL, tool_id INT(11) NOT NULL, info JSON, createAt BIGINT(20) NOT NULL)'
